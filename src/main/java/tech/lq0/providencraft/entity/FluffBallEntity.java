...
public class FluffBallEntity extends ProjectileItemEntity {

    public FluffBallEntity(EntityType<? extends FluffBallEntity> p_i50159_1_, World p_i50159_2_) {
        super(p_i50159_1_, p_i50159_2_);
    }

    public FluffBallEntity(World world, LivingEntity entity) {
        super(EntityRegistry.FLUFF_BALL_ENTITY.get(), entity, world);
    }

    public FluffBallEntity(World p_i1775_1_, double p_i1775_2_, double p_i1775_4_, double p_i1775_6_) {
    ...
    protected void onEntityHit(EntityRayTraceResult p_213868_1_) {
        ...
        if (entity instanceof LivingEntity) {
            entity.attackEntityFrom(DamageSource.causeThrownDamage(this, this.func_234616_v_()), 0f);
        }
    }
