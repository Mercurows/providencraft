...
public class PointsStoreTileEntity extends TileEntity implements IMerchant, ITickableTileEntity {
    ...
    private static final MerchantOffer[] offers = {
            ...
            new MerchantOffer(getPoints(6), getGoods(ItemRegistry.RABBIT_LYCHEE.get(), 8), 64, 0, 0),
            new MerchantOffer(getPoints(10), getGoods(ItemRegistry.MOON_CAKE.get(), 8), 64, 0, 0),
            ...
            new MerchantOffer(getPoints(28), getGoods(ItemRegistry.FOX_FAIRY_FAN.get(), 1), 64, 0, 0),
            ...
            new MerchantOffer(getPoints(38), getGoods(ItemRegistry.SATOU_CAMERA.get(), 1), 64, 0, 0),
