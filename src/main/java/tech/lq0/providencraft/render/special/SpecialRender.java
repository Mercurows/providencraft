...
public class SpecialRender {
    ...
    public static void renderYeggyPearl(RenderGameOverlayEvent event){
        ...
        if (player != null && player.getItemStackFromSlot(EquipmentSlotType.HEAD).getItem() == ItemRegistry.YEGGY_PEARL.get()) {
            ...
            drawNumber(matrixBar, 1, (int) left - 43, (int) top + 64, num1, color1);
            GuiUtils.drawGradientRect(matrixBar, 1, (int) left - 39, (int) top + 68, (int) left - 38, (int) top + 69, color3, color3);
            drawNumber(matrixBar, 1, (int) left - 37, (int) top + 64, num2, color1);
            drawNumber(matrixBar, 1, (int) left - 33, (int) top + 64, num3, color1);
