...
public class ChiramIdolLeggings extends ArmorItem {
    public ChiramIdolLeggings(){
        super(ModArmorMaterial.IDOL_COSTUME, EquipmentSlotType.LEGS, new Properties().group(ModGroup.costumegroup));
    }
