package tech.lq0.providencraft.item.costume.magicros.chiram;
...
public class ChiramIdolHelmet extends ArmorItem {
    public ChiramIdolHelmet() {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        tooltip.add((new TranslationTextComponent("des.providencraft.chiram_idol_costume")).mergeStyle(TextFormatting.GRAY));
