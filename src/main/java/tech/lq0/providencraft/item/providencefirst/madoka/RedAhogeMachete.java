...
public class RedAhogeMachete extends SwordItem {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        tooltip.add((new TranslationTextComponent("des.providencraft.red_ahoge_machete_1")).mergeStyle(TextFormatting.GRAY));
        tooltip.add((new TranslationTextComponent("des.providencraft.red_ahoge_machete_2")).mergeStyle(TextFormatting.GRAY).mergeStyle(TextFormatting.STRIKETHROUGH));
        tooltip.add((new TranslationTextComponent("des.providencraft.red_ahoge_machete.func")).mergeStyle(TextFormatting.AQUA));
