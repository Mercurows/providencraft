...
public class MagicMirrorBlock extends Block {
    ...
    protected static final VoxelShape SHAPE_EW = Block.makeCuboidShape(5, 0, 0, 11, 8, 16);
    protected static final VoxelShape SHAPE_NS = Block.makeCuboidShape(0, 0, 5, 16, 8, 11);
