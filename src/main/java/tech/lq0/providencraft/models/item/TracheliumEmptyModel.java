...
public class TracheliumEmptyModel extends AnimatedGeoModel<Trachelium> {
    ...
    public ResourceLocation getAnimationFileLocation(Trachelium animatable) {
        return new ResourceLocation(Utils.MOD_ID, "animations/trachelium_empty.animation.json");
    }
}
